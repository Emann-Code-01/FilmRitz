        ...
        <div class="space-y-6">
          <div class="flex justify-between items-center">
            ...
            <button
              ...
              class="px-4 py-2 bg-white/10 hover:bg-[#b20710] text-white rounded-xl font-[Gilroy-SemiBold] transition-all flex items-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
          ...
          >
            ...
            <button
              v-if="auth.isLoggedIn"
              @click="openReviewModal"
              class="px-6 py-3 bg-[#b20710] hover:bg-[#e32125] text-white rounded-xl font-[Gilroy-Bold] transition-all"
            >
              Write a Review
            </button>
