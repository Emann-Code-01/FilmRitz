...
useHead({
  title: computed(() =>
    person.value
      ? `${person.value.name} — FilmRitz`
      : "Actor Profile — FilmRitz",
  ),
  meta: [
    {
      name: "description",
      content: computed(() =>
        person.value
          ? person.value.biography?.slice(0, 160)
          : "Explore the biography and filmography of your favorite actors on FilmRitz.",
      ),
    },
