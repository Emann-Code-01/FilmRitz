  ...
  >
    ...
    >
      ...
      >
        ...
        <router-link
          to="/ng"
          class="inline-flex items-center gap-2 px-6 py-3 bg-[#b20710] hover:bg-[#8f0509] text-white font-[Gilroy-Bold] rounded-xl transition-all duration-300"
        >
          <svg
      ...
      <div class="grid md:grid-cols-12 gap-6 lg:gap-8 mb-12 lg:mb-16">
        ...
        <div class="md:col-span-4 lg:col-span-3">
          <div class="sticky top-24 space-y-4 lg:space-y-6">
            <!-- Profile Image -->
            <div
              class="relative rounded-2xl overflow-hidden border-2 border-white/10 group shadow-2xl"
            >
              <img
            ...
            <div class="space-y-3">
              ...
              >
                <p
                  class="text-gray-400 text-xs lg:text-sm font-[Gilroy-Medium] mb-2 uppercase tracking-wider"
                >
                  Profession
                </p>
        ...
        <div class="md:col-span-8 lg:col-span-9">
          <div class="space-y-6 lg:space-y-8">
            ...
            <div class="space-y-2">
              <h1
                class="text-4xl md:text-5xl lg:text-6xl font-[Gilroy-Bold] text-white leading-tight"
              >
                {{ person.name }}
              </h1>
            ...
            >
              <h2
                class="text-2xl lg:text-3xl font-[Gilroy-Bold] mb-4 flex items-center gap-3"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <div class="space-y-4">
                <p
                  ...
                  class="text-gray-400 italic text-sm lg:text-base"
                >
    ...
    <div
      ...
      class="mb-12 lg:mb-16 max-w-[1230px] lg:max-w-[1440px] mx-auto pt-4"
    >
      ...
      <div class="relative">
        <div
          class="flex gap-3 lg:gap-4 overflow-x-auto pb-4 snap-x snap-mandatory"
        >
          <div
            ...
            >
              <div class="aspect-2/3 relative">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-3">
                  <p
                    class="text-white font-[Gilroy-Bold] text-xs lg:text-sm line-clamp-2 mb-1"
                  >
    ...
    <!-- Filmography Tabs -->
    <div class="mb-12 lg:mb-16 max-w-[1230px] lg:max-w-[1440px] mx-auto pt-4">
      <div class="flex items-center justify-between mb-6 lg:mb-8">
        <div class="flex items-center gap-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="flex gap-2 mb-6 overflow-x-auto">
        <button
          ...
          :class="[
            'px-6 py-3 rounded-xl font-[Gilroy-Bold] text-sm transition-all whitespace-nowrap cursor-pointer',
            activeTab === 'movies'
      ...
      <div class="space-y-3">
        ...
        >
          <div class="flex items-start gap-4">
            <div
              class="shrink-0 w-12 h-16 lg:w-16 lg:h-20 rounded-lg overflow-hidden border border-white/20"
            >
              <img
                v-if="item.poster_path"
                :src="getPoster(item.poster_path, 'w92')"
                :alt="item.title || item.name"
            ...
            <div class="flex-1 min-w-0">
              ...
              <p
                class="text-gray-400 font-[Gilroy-Medium] text-xs lg:text-sm mt-1"
              >
      ...
      <!-- Show More Button -->
      <div
        v-if="currentFilmography.length > itemsToShow"
