    ...
    <div v-else>
      ...
      >
        ...
        <div class="absolute bottom-0 left-0 right-0 p-6 md:p-12 mx-auto">
          ...
          >
            <h2
              class="text-2xl md:text-3xl font-[Gilroy-SemiBold] text-gray-300 mb-3"
            >
              {{ latestSeason.name }}
            </h2>
            <div class="flex flex-wrap items-center gap-3 md:gap-4 mb-4">
              ...
              <span
                class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-xl font-[Gilroy-Medium]"
              >
                {{
      ...
      <div class="px-6 md:px-12 mx-auto mt-12 transition-all duration-500">
        ...
        <div class="space-y-6 transition-all duration-500">
          ...
          >
            ...
            >
              <div
                class="flex items-start justify-between trasistion-all duration-500"
              >
                <div class="flex-1">
                  ...
                  <div
                    class="flex flex-wrap items-center gap-3 text-gray-400 font-[Gilroy-Medium] mb-3"
                  >
                    <span>{{
                      season.air_date
                ...
                <button
                  ...
                  :class="
                    selectedSeason === season.season_number && 'rotate-180'
                  "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                >
                  ...
                  <div class="p-4">
                    ...
                    <p
                      class="text-gray-400 font-[Gilroy-Regular] text-sm line-clamp-2 mb-2"
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="flex-1 min-w-0">
                            ...
                            <p
                              class="text-sm text-gray-400 font-[Gilroy-Regular] truncate"
                            >
...
useHead({
  title: computed(() =>
    tv.value
      ? `${tv.value.name} — All Seasons & Episodes | FilmRitz`
  ...
  meta: [
    {
      ...
      content: computed(() =>
        tv.value
          ? `Watch ${tv.value.name} seasons and episodes. ${tv.value.overview?.slice(0, 150)}...`
          : "Explore TV show seasons, episodes, and cast on FilmRitz.",
      ),
    },
    {
      property: "og:title",
      content: computed(() => (tv.value ? tv.value.name : "TV Show Details")),
    },

    {
      property: "og:description",
      content: computed(() =>
        tv.value ? tv.value.overview : "Watch on FilmRitz",
      ),
    },
    {
      property: "og:image",
