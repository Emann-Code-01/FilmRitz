...
const Advertising = () => import("@/pages/AdsInfo.vue");
const TrailerCinema = () => import("@/pages/trailers/TrailerCinema.vue");
const LogoutScreen = () => import("@/pages/LogoutScreen.vue");
const Discovery = () => import("@/pages/Discovery.vue");
const WatchlistsPage = () => import("@/pages/WatchlistsPage.vue");
const MyList = () => import("@/pages/user/MyListPage.vue");
...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        path: "admin/seed",
        name: "AdminSeed",
        component: () => import("@/pages/admin/AdminSeed.vue"),
        meta: { requiresAuth: true }, // Should check admin role ideally
      },
