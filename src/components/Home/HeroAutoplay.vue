    ...
    <div class="absolute bottom-20 left-12 max-w-2xl z-10">
      ...
      <div class="flex gap-4">
        <button
          ...
          class="px-6 py-3 bg-white text-black rounded-lg font-[Gilroy-SemiBold] hover:bg-white/90 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled
        >
        ...
        <button
          class="px-6 py-3 bg-white/20 backdrop-blur-sm text-white rounded-lg font-[Gilroy-SemiBold] hover:bg-white/30 transition-all"
        >
          ℹ More Info
        </button>
      </div>
