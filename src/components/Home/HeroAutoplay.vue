<template>
  <div class="relative w-full h-screen overflow-hidden">
    ...
    <div
      ...
      class="absolute inset-0 transition-all duration-1000 blur-3xl opacity-60"
    ...
    <div class="absolute inset-0 pointer-events-none">
      ...
      <div
        class="absolute bottom-0 w-full h-40 bg-linear-to-t from-black/80 to-transparent"
      />
    </div>
    ...
    <div class="absolute bottom-20 left-12 max-w-2xl z-10">
      ...
      <div class="flex gap-3 mb-4">
        <span
          v-for="genreId in currentSlide.genre_ids?.slice(0, 3) || []"
          :key="genreId"
      ...
      <div class="flex gap-4">
        <button
          ...
          class="px-3 md:px-6 py-2 md:py-2.5 bg-white text-black rounded-lg font-[Gilroy-SemiBold] hover:bg-white/90 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled
        >
          <span
            ><svg
        ...
        <button
          class="px-3 md:px-6 py-2 md:py-2.5 bg-white/20 backdrop-blur-sm text-white rounded-lg font-[Gilroy-SemiBold] hover:bg-white/30 transition-all"
        >
          ℹ More Info
        </button>
      </div>
    ...
    <div class="absolute bottom-0 left-0 right-0 h-1 bg-white/20">
      <div
        class="h-full bg-[#b20710] transition-all duration-200"
...
const currentSlide = computed<HeroSlide>(
  () => props.slides[currentSlideIndex.value],
);
