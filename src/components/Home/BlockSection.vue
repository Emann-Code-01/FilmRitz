<template>
  <section class="bg-[#000000] min-h-fit relative z-10 overflow-hidden -mt-16 px-2 py-20 xl:px-32 md:px-14 space-y-10">
    <div class="space-y-5">
    ...
    <div class="space-y-5 text-white transition-all duration-900 animate-fade-up">
      <h1 class="font-[Gilroy-Bold] text-2xl xl:text-3xl transition-all duration-900 animate-fade-up">
      ...
      <div
        ...
        <div
          ...
          <div class="space-y-3 transition-all duration-900 animate-fade-up">
            <h1 class="font-[Gilroy-Bold] text-2xl transition-all duration-900 animate-fade-up">
              Enjoy on your TV
            </h1>
            <p class="font-[Gilroy-Medium] text-white/60 transition-all duration-900 animate-fade-up">
              Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV,
              Blu-ray players, and more.
            </p>
          </div>
          <div class="absolute right-0 bottom-0 mb-5 mr-7 transition-all duration-900 animate-fade-up">
        ...
        <div
          ...
          <div class="absolute right-0 bottom-0 mb-5 mr-8 transition-all duration-900 animate-fade-up">
            <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
      ...
      <div class="" v-for="(faq, index) in faqs" :key="id">
        <div class="space-y-0.5 transition-all duration-900 animate-fade-up">
          <button ref="initialFocus" @click="toggle(index)"
            ...
            <span @click="openFAQ">
              <svg v-if="activeIndex !== index" viewBox="0 0 36 36" width="36" height="36" data-icon="PlusLarge"
                data-icon-id=":r38:" aria-hidden="true" class="default-ltr-iqcdef-cache-1ulhx3w e164gv2o4"
              ...
              <svg v-else viewBox="0 0 36 36" width="36" height="36" data-icon="PlusLarge" data-icon-id=":r9:"
                aria-hidden="true" class="tramsform -rotate-45" xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    <div class="text-white space-y-5 flex flex-col transition-all duration-900 animate-fade-up items-center">
