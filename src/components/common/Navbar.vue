  ...
  <nav :class="[
    ...
    <div class="flex justify-center items-center gap-3">
      <router-link to="/ng" class="cursor-pointer">
        <img loading="lazy" :src="currentLogo" alt="Filmritz Logo" :class="router.currentRoute.value.path.startsWith('/ng')
          ? auth.isLoggedIn &&
            router.currentRoute.value.path !== '/forgot-password' &&
            router.currentRoute.value.path !== '/reset-password'
        ...
        <div class="hidden xl:flex xl:space-x-6 transition duration-500 animate-fade-up">
          ...
          <div class="relative group cursor-pointer pt-0.5">
            ...
            <div
              ...
              <router-link to="/ng/trending"
                class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                Trending
              </router-link>
              <router-link to="/ng/popular"
                class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                Popular
              </router-link>
              <router-link to="/ng/top-rated"
              ...
              <router-link to="/ng/new-releases"
                class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                New Releases
              </router-link>
              <router-link to="/ng/coming-soon"
          ...
          <div class="relative group cursor-pointer pt-0.5">
            ...
            <div
              ...
              <router-link to="/ng/mood/happy"
                class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                By Mood
              </router-link>
              <router-link to="/ng/trailers"
                class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                All Trailers
              </router-link>
              <router-link to="/ng/trending-trailers"
                class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                Trending Trailers
              </router-link>
              <router-link to="/ng/trailercinema"
          ...
          <router-link to="/ng/genre/action" :class="[
          ...
          <router-link v-if="auth.isLoggedIn" to="/ng/my-list" :class="[
    ...
    " class="flex items-center gap-5 transition-all animate-fade-up duration-900">
      <button class="flex md:hidden cursor-pointer" type="button" @click="openModal">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-gray-300">
      ...
      <TransitionRoot appear :show="isOpen" as="template">
        <Dialog as="div" @close="closeModal" class="relative z-9999">
          <TransitionChild as="template" enter="duration-500 ease-out" enter-from="opacity-0 -translate-y-5"
      ...
      <div v-if="auth.isLoggedIn" class="relative group">
        <button @click="handleMenuButtonClick3"
        ...
        <transition name="slide-fade">
          <div v-if="show3"
            ...
            <router-link to="/ng" class="xl:hidden" @click="closeMenuOnMobile" :class="[
              isActiveLink('/ng')
            ...
            <button @click="handleMenuButtonClick"
              ...
              Browse
              <span class="flex items-center justify-center transition-transform duration-300"
                :class="[show ? 'group-hover:rotate-180 group-hover:text-white' : '']">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            ...
            <transition name="slide-fade">
              <div v-if="show" class="bg-black/95 backdrop-blur-xl border border-white/10 transition-all">
                <router-link to="/ng/movies" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Movies
                </router-link>
                <router-link to="/ng/tv-shows" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  TV Shows
                </router-link>
                <router-link to="/ng/trending" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Trending
                </router-link>
                <router-link to="/ng/popular" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Popular
                </router-link>
                <router-link to="/ng/top-rated" @click="closeMenuOnMobile"
                  class="flex items-center gap-2 px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Top Rated
                </router-link>
                <router-link to="/ng/new-releases" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  New Releases
                </router-link>
                <router-link to="/ng/coming-soon" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Coming Soon
                </router-link>
              </div>
            </transition>
            <button @click="handleMenuButtonClick2"
              class="text-white font-[Gilroy-SemiBold] hover:text-red-500 transition-colors flex items-center gap-2 cursor-pointer px-4 py-3 xl:hidden">
              Discover
              <span class="flex items-center justify-center transition-transform duration-300"
                :class="[show2 ? 'group-hover:rotate-180 group-hover:text-white' : '']">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            ...
            <transition name="slide-fade">
              <div v-if="show2" class="bg-black/95 backdrop-blur-xl border border-white/10 transition-all">
                <router-link to="/ng/collections" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Collections
                </router-link>
                <router-link to="/ng/mood/happy" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  By Mood
                </router-link>
                <router-link to="/ng/trailers" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  All Trailers
                </router-link>
                <router-link to="/ng/trending-trailers" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Trending Trailers
                </router-link>
                <router-link to="/ng/trailercinema" @click="closeMenuOnMobile"
                  class="block px-4 py-3 hover:bg-white/10 hover:text-red-500 hover:font-[Gilroy-Medium] text-white font-[Gilroy-Medium] transition-colors">
                  Trailer Cinema
                </router-link>
              </div>
            </transition>
            <router-link to="/ng/genre/action" @click="closeMenuOnMobile" class="xl:hidden" :class="[
              isActiveLink('/ng/genre/action')
                ? 'hover:text-red-500 block px-4 py-3 text-red-500 font-[Gilroy-SemiBold] transition-all duration-200 hover:duration-500 hover:underline bg-accent ease-in'
                : 'hover:text-red-500 block px-4 py-3 text-white font-[Gilroy-SemiBold] transition-all duration-200 hover:underline false',
            ]">
            ...
            <router-link to="/ng/my-list" class="xl:hidden" @click="closeMenuOnMobile" :class="[
              isActiveLink('/ng/my-list')
                ? 'hover:text-red-500 block px-4 py-3 text-red-500 font-[Gilroy-SemiBold] transition-all duration-200 hover:duration-500 hover:underline bg-accent ease-in'
                : 'hover:text-red-500 block px-4 py-3 text-white font-[Gilroy-SemiBold] transition-all duration-200 hover:underline false',
            ]">
            ...
            <router-link to="/ng/history" @click="closeMenuOnMobile" :class="[
            ...
            <router-link to="/ng/profile" @click="closeMenuOnMobile" :class="[
            ...
            <button v-if="isLoggedIn" @click="logout" :disabled="isLoggingOut"
              ...
              <span v-if="!isLoggingOut" @click="closeMenuOnMobile" class="flex items-center gap-3">Sign Out<svg
