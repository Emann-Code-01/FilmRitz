<template>
  <nav
    :class="[
      'fixed top-0 left-0 w-full py-5 z-50 transition-all duration-500 ease-out',
      scrolled
    ...
    <div class="page-container flex items-center justify-between">
      ...
      >
        ...
        <div
          ...
          v-if="
            router.currentRoute.value.path !== '/ng/login' || auth.isLoggedIn
          "
        >
          <div
            v-if="
          ...
          >
            <router-link
              to="/ng/login"
              class="px-3 md:px-6 py-2 md:py-2.5 rounded-full bg-red-500 hover:text-filmritz-accent text-white font-[Gilroy-SemiBold] transition-all animate-fade-up duration-900"
            >
              Sign In
            </router-link>
