    ...
    <section
        ...
        <div class="space-y-5 text-white transition-all duration-900 animate-fade-up">
            ...
            <div
                ...
                <div
                    class="relative xl:rounded-br-3xl rounded-3xl bg-[linear-gradient(to_top_left,_rgba(255,153,0,0.6)_0%,_rgba(229,9,20,0.6)_20%,_rgba(14,27,79,0.6)_77%,_rgba(0,4,19,0.6)_100%)] xl:w-full h-80 px-5 py-5 transition-all duration-900 animate-fade-up md:mr-2.5">
                    <div class="space-y-3 transition-all duration-900 animate-fade-up">
                        <h1 class="font-[Gilroy-Bold] text-2xl transition-all duration-900 animate-fade-up">Enjoy on
                            your TV</h1>
                        <p class="font-[Gilroy-Medium] text-white/60 transition-all duration-900 animate-fade-up ">Watch
                            on Smart TVs, Playstation, Xbox, Chromecast,
                            Apple TV,
                ...
                <div
                    class="relative xl:rounded-br-3xl rounded-3xl bg-[linear-gradient(to_top_left,_rgba(255,153,0,0.6)_0%,_rgba(229,9,20,0.6)_20%,_rgba(14,27,79,0.6)_77%,_rgba(0,4,19,0.6)_100%)] xl:w-full h-80 px-5 py-5 transition-all duration-900 animate-fade-up md:ml-2.5">
                    <div class="space-y-3 transition-all duration-900 animate-fade-up">
                        <h1 class="font-[Gilroy-Bold] text-2xl transition-all duration-900 animate-fade-up">Download
                            your shows to watch offline</h1>
                        <p class="font-[Gilroy-Medium] text-white/60 transition-all duration-900 animate-fade-up">Save
                            your favorites easily and always have
                            something to watch.
                        </p>
                    </div>
                    <div class="absolute right-0 bottom-0 mb-5 mr-7 transition-all duration-900 animate-fade-up">
                ...
                <div
                    class="relative xl:rounded-br-3xl rounded-3xl bg-[linear-gradient(to_top_left,_rgba(255,153,0,0.6)_0%,_rgba(229,9,20,0.6)_20%,_rgba(14,27,79,0.6)_77%,_rgba(0,4,19,0.6)_100%)] xl:w-full h-80 px-5 py-5 transition-all duration-900 animate-fade-up md:mr-2.5">
                    <div class="space-y-3 transition-all duration-900 animate-fade-up">
                        <h1 class="font-[Gilroy-Bold] text-2xl transition-all duration-900 animate-fade-up">Watch
                            everywhere</h1>
                        <p class="font-[Gilroy-Medium] text-white/60 transition-all duration-900 animate-fade-up">Stream
                ...
                <div
                    class="relative xl:rounded-br-3xl rounded-3xl bg-[linear-gradient(to_top_left,_rgba(255,153,0,0.6)_0%,_rgba(229,9,20,0.6)_20%,_rgba(14,27,79,0.6)_77%,_rgba(0,4,19,0.6)_100%)] xl:w-full h-80 px-5 py-5 transition-all duration-900 animate-fade-up md:ml-2.5">
                    <div class="space-y-3 transition-all duration-900 animate-fade-up">
                        <h1 class="font-[Gilroy-Bold] text-2xl transition-all duration-900 animate-fade-up">Create
                            profiles for kids</h1>
                        <p class="font-[Gilroy-Medium] text-white/60 transition-all duration-900 animate-fade-up">Send
                            kids on adventures with their favorite
                            characters in a
                            space
        ...
        <div class="text-white space-y-5 flex flex-col transition-all duration-900 animate-fade-up items-center">
            <h1 class="text-[Gilroy-SemiBold] text-lg text-center md:text-xl">Ready to watch? Enter your email to create
                or restart your
                membership.</h1>
...
const faqs = [
    {
        ...
        answer1: `FilmRitz is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices.`,
    ...
    },
    {
        ...
        answer1: `Watch FilmRitz on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from ₦2,500 to ₦8,500 a month. No extra costs, no contracts.`,
    },
    {
        id: 3,
        question: `Where can i watch?`,
        answer1: `Watch anywhere, anytime. Sign in with your FilmRitz account to watch instantly on the web at FilmRitz.com from your personal computer or on any internet-connected device that offers the FilmRitz app, including smart TVs, smartphones, tablets, streaming media players and game consoles.`,
        answer2: `You can also download your favorite shows with the iOS or Android app. Use downloads to watch while you're on the go and without an internet connection. Take FilmRitz with you anywhere.`,
    },
    {
        id: 4,
        question: `How do i cancel?`,
        answer1: `FilmRitz is flexible. There are no pesky contracts and no commitments. You can easily cancel your account online in two clicks. There are no cancellation fees – start or stop your account anytime.`,
    },
    {
        id: 5,
        question: `What can i watch on  FilmRitz?`,
        answer1: `FilmRitz has an extensive library of feature films, documentaries, TV shows, anime, and more. Watch as much as you want, anytime you want.`,
    },
    {
        id: 6,
        question: `Is FilmRitz good for Kids?`,
        answer1: `The FilmRitz Kids experience is included in your membership to give parents control while kids enjoy family-friendly TV shows and movies in their own space.`,
