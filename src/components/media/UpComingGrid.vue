      ...
      <div class="grid grid-cols-12 gap-4 auto-rows-auto">
        ...
        >
          ...
          >
            ...
            <p
              class="text-gray-300 text-base font-[Gilroy-Regular] line-clamp-3 mb-4 max-w-2xl lg:opacity-0 lg:translate-y-5 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-500 group-hover:animate-fade-up delay-100"
            >
...
const loadUpcomingMedia = async () => {
  ...
  try {
    ...
    // Use rotated upcoming for variety (cached for 6 hours)
    mediaList.value = await getRotatedUpcoming();
  } catch (err: any) {
